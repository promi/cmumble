...
static const ProtobufCEnumValue mumble_proto__reject__reject_type__enum_values_by_number[9] =
{
  ...
  { "AuthenticatorFail", "MUMBLE_PROTO__REJECT__REJECT_TYPE__AuthenticatorFail", 8 },
};
static const ProtobufCIntRange mumble_proto__reject__reject_type__value_ranges[] = {
{0, 0},{0, 9}
};
static const ProtobufCEnumValueIndex mumble_proto__reject__reject_type__enum_values_by_name[9] =
{
  { "AuthenticatorFail", 8 },
  { "InvalidUsername", 2 },
  { "NoCertificate", 7 },
...
static const ProtobufCFieldDescriptor mumble_proto__channel_state__field_descriptors[11] =
{
  {
    "channel_id",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    offsetof(MumbleProto__ChannelState, has_max_users),
    offsetof(MumbleProto__ChannelState, max_users),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor mumble_proto__user_list__user__field_descriptors[4] =
{
  {
    "user_id",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(MumbleProto__UserList__User, last_seen),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    offsetof(MumbleProto__UserList__User, has_last_channel),
    offsetof(MumbleProto__UserList__User, last_channel),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor mumble_proto__server_config__field_descriptors[6] =
{
  {
    "max_bandwidth",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    offsetof(MumbleProto__ServerConfig, has_max_users),
    offsetof(MumbleProto__ServerConfig, max_users),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
